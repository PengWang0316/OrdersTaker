...
const NOTIFICATION_OPEN_URL = 'https://kairoscope.resonancepath.com/sharedReadings';
const NOTIFICATION_TITLE = 'Order Taker';
...
self.addEventListener('notificationclick', event => {
  ...
  const urlToOpen = new URL(NOTIFICATION_OPEN_URL, self.location.origin).href;
